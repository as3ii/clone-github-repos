...
class Remote:
    ...
    def get_list_repos(self):
        url = f"https://gitlab.com/api/v4/users/{self.username}/projects"
        ...
        if response.status_code == 404:
            ...
            sys.exit(f"{Fore.RED}{Style.BRIGHT}Ther is a problem. Check on https://docs.gitlab.com/ee/api/#status-codes this code: {reposnse.status_code}")
        elif response.text == "[]":
    ...
    def clone_repos(self, repos=[]):
        ...
        for repo in repo_array:
            ...
            subprocess.run(["git","clone",f"https://gitlab.com/{self.username}/{repo}.git"])
